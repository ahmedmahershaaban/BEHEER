...
import 'package:ringo_media_management/presentation/components/snackbar/icon_animated.dart';
...
class SnackBarStyle {
  ...
  const SnackBarStyle({this.backgroundColor, this.iconColor = Colors.white, this.labelTextStyle});
}
                  ...
                  child: Container(
                    ...
                    child: CircleAvatar(
                        ...
                        child: AnimatedContainer(
                          duration: const Duration(milliseconds: 400),
                          child: IconAnimated(
                            color: _fadeAnimationStart ? Colors.white : widget.backgroundColor,
                            active: true,
                            size: 40,
